...
def setup(sim):
    ...
    sim.addCell(cellType=0, pos=(-10,-40,0), dir=(1,0,0))
    sim.addCell(cellType=1, pos=(10,-40,0), dir=(1,0,0))
    sim.addCell(cellType=0, pos=(-5,0,0), dir=(1,0,0))
    sim.addCell(cellType=1, pos=(5,0,0), dir=(1,0,0))
    sim.addCell(cellType=0, pos=(-3,40,0), dir=(1,0,0))
    sim.addCell(cellType=1, pos=(3,40,0), dir=(1,0,0))
